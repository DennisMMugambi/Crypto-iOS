...
//  Crypto-iOS
//
//  Created by Dennis Mutwiri Mugambi on 16/08/2023.
//
...
extension Double {
    ...
    private var currencyFormatter2: NumberFormatter {
        ...
        formatter.currencySymbol = "$" //change default symbol
        formatter.minimumFractionDigits = 2
        formatter.maximumFractionDigits = 2
        return formatter
    }
    
    ///Converts a double into a currency as a String with 2 to 2 decimal places
    ///```
    ///Convert 1234.56 to $1,234.56
    ///```
